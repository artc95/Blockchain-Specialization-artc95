  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return auctionInstance.getPersonDetails(0, {from: accounts[0]});
    }).then(function(result) {
      /**********
      ...
      ***********/
      assert.notEqual(result.toString(), '0x0000000000000000000000000000000000000000', 'Winner address is not default address');
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return auctionInstance.getPersonDetails(1, {from: accounts[0]});
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.getPersonDetails(2, {from: accounts[3]});
    }).then(function(result) {
      /**********
